...
export function AboutPage() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      toast.success(data?.message || `Thank you, ${name}. We will reply as soon as possible.`);
          ...
          >
            <Card className="border-none shadow-xl bg-white">
              ...
              <CardContent className="space-y-4">
                ...
                <Button type="button" className="w-full bg-brand-olive hover:bg-brand-olive/90" onClick={handleSend} disabled={sending}>
